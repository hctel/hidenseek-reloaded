...
public enum HideAchievement {
	...
	private HideAchievement(String name, String description, String json, int unlockLevel) {
		this.name = name;
	...
	public String getName(HideAchievement achievement) {
		return name;
	}
	public String getDescription(HideAchievement achievement) {
		return description;
	}
	public String getJsonCode(HideAchievement achievement) {
		return json;
	}
